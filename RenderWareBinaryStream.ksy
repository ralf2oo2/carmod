  ...
  - id: body
    ...
    type:
      ...
      cases:
        ...
        sections::material_list: list_with_header
        sections::texture_dictionary: list_with_header
        sections::texture_native: list_with_header
        sections::atomic: list_with_header
        sections::material: list_with_header
        sections::texture: list_with_header
        sections::string: struct_string
        sections::extension: struct_extension
instances:
  version:
      ...
      - id: header
        ...
        type:
          ...
          cases:
            ...
            sections::texture_native: struct_texture_data
            sections::material_list: struct_material_list
            sections::material: struct_material
            sections::texture: struct_texture
      - id: entries
      ...
      - id: extension
        type:
          ...
          cases:
            ...
            sections::collision_model: collision_extension
  geometry_extension:
    seq:
      - id: face_type
        type: u4

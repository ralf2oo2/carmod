...
public final class DDSReader {
    ...
    public static final Order DXT1Order = new Order(24, 16, 8, 0);
    public static final Order DXT3Order = new Order(24, 16, 8, 0);
    ...
    public static int [] read(byte [] buffer, Order order, int mipmapLevel, int width, int height, int type) {
